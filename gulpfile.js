...
gulp.task(
  'lib',
  gulp.series('vendor', function () {
    return gulp.src(libRegex).pipe(cached('lib')).pipe(plumber()).pipe(gulp.dest(libDest))
  })
)

gulp.task('image', function () {
  return gulp.src(assetsRegex).pipe(plumber()).pipe(imagemin()).pipe(gulp.dest('.'))
})
